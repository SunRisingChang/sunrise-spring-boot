package com.sunrise.core.utils.page.factory;
...
public abstract class DataBaseFactory {
	 ...
	 *
	 */
	public static DataBaseHandle getDataBaseHandle(DataBaseType dbType) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
