...
/**
 * <p>
 * Title:CheckExcelFileTypeUtil
 * </p>
 * <p>
 * Description: 类描述：获取和判断文件头信息 <br>
 * &nbsp;&nbsp;|--文件头是位于文件开头的一段承担一定任务的数据，一般都在开头的部分。 <br>
 ...
 * <br>
 * 问题说明： <br>
 * &nbsp;&nbsp;|--文件头有些信息在windows上运行，对应不上。是否是在linux下才是这些文件头？还有待验证。暂时因为只是需要判断excel格式，因此暂不验证。有空我会补充。
 * </p>
 * 
 * @author 鲁东顺(这不是公司人是从外面找的代码)
...
public class FileTypeUtils {
	...
	static {
		...
		FILE_TYPE_MAP.put("504b0304140006000800", "office");// docx文件 xlsx文件,我只能知道是office
