package com.sunrise.core.utils.page;

import com.sunrise.core.utils.page.factory.DataBaseFactory;
...
public class DataPageUtils {
	 ...
	 *
	 */
	public static DataBaseHandle getDataPageUtils(DataBaseType dbType) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
